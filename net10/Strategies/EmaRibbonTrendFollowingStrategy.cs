...
public class EmaRibbonTrendFollowingStrategy
{
    ...
    private readonly int[] _emaPeriods = { 5, 10, 20, 40 };
    ...
    public AnalysisResult Analyze(string symbol, List<Candle> candles)
    {
        ...
        var lastEma40 = emaRibbon[40].Last();

        result.Indicators["EMA5"] = lastEma5;
        result.Indicators["EMA10"] = lastEma10;
        result.Indicators["EMA20"] = lastEma20;
        result.Indicators["EMA40"] = lastEma40;
        result.CurrentPrice = currentPrice;

        // 2️⃣ TREND FILTER - Ribbon Alignment Check
        // Uptrend: EMA5 > EMA10 > EMA20 > EMA40
        // Downtrend: EMA5 < EMA10 < EMA20 < EMA40
        bool isUptrendAligned = lastEma5 > lastEma10 && lastEma10 > lastEma20 && lastEma20 > lastEma40;
        bool isDowntrendAligned = lastEma5 < lastEma10 && lastEma10 < lastEma20 && lastEma20 < lastEma40;
